...
export default function Checkbox({ label, id, checked: controlledChecked, onChange, className = '', ...props }) {
  ...
  return (
    ...
    >
      <div
        className={`w-3 h-3 rounded-[3px] border flex items-center justify-center transition-all duration-150 ${
          checked
      ...
      >
        {checked && (
          <svg
            className="w-[7px] h-[7px] text-[#2d8ceb] drop-shadow-[0_0_3px_rgba(45,140,235,0.5)]"
            viewBox="0 0 8 8"
            fill="none"
            stroke="currentColor"
            strokeWidth="2"
